...
const branches = [
  { id: 1, name: 'Tashkent City Branch' },
  { id: 2, name: 'Bukhara Branch' },
  { id: 3, name: 'Andijan Branch' },
];
...
export default function EmployeeForm({ submitForm }) {
  ...
  return (
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault();
        submitForm(name, email, password, passwordConfirm, role, branch);
      }}
    >
      <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div>
          ...
          <div className="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
            ...
            <SelectComponent options={roles} value={role} onChange={(value) => setRole(value)} />
